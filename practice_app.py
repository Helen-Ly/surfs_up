#---------------------------------------------
# Changed file name because module wants us to 
# create a new file with the same name 'app.py'
#---------------------------------------------
...
# export FLASK_APP = practice_app.py # MAC users
# $env: FLASK_APP = 'practice_app.py' #Windows users
